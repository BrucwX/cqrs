...
func (q *absenceRecordQuery) PageAbsences(_ context.Context, page, pageSize int) ([]*absence.AbsenceRecord, error) {
...
func (q *absenceRecordQuery) ListAbsencesByCourseID(_ context.Context, courseID string) ([]*absence.AbsenceRecord, error) {
	out := make([]*absence.AbsenceRecord, 0)
	for _, item := range q.data.Absences() {
