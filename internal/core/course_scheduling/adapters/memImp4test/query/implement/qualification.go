...
func NewQualificationQuery(d *query.Data) repoquery.QualificationQuery {
	return &qualificationQuery{data: d}
}

// PageQualifications 分页查询授课资质列表。
func (q *qualificationQuery) PageQualifications(_ context.Context, page, pageSize int) ([]*qualification.Qualification, error) {
