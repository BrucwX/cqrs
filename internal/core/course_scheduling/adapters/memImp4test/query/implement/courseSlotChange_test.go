...
func TestCourseSlotChangeQueryPage(t *testing.T) {
	...
	got, err := q.PageCourseSlotChanges(context.Background(), 1, 10)
	if err != nil {
...
func TestCourseSlotChangeQueryListByCourseID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := q.ListCourseSlotChangesByCourseID(context.Background(), tt.courseID)
			if err != nil {
...
func TestCourseSlotChangeQueryReturnsSeededFields(t *testing.T) {
	...
	got, err := q.ListCourseSlotChangesByCourseID(context.Background(), "C001")
	if err != nil {
		t.Fatalf("ListByCourseID() error = %v", err)
	}
