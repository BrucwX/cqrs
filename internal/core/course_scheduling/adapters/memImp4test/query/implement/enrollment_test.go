...
func TestCourseEnrollmentQueryPage(t *testing.T) {
	...
	got, err := q.PageEnrollments(context.Background(), 1, 10)
	if err != nil {
...
func TestCourseEnrollmentQueryCoursesByStudentID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := q.EnrolledCoursesByStudentID(ctx, tt.studentID)
			if err != nil {
...
func TestCourseEnrollmentQueryStudentsByCourseID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := q.EnrolledStudentsByCourseID(ctx, tt.courseID)
			if err != nil {
...
func TestCourseEnrollmentQueryDoesNotFilterStatus(t *testing.T) {
	...
	completed, err := q.EnrolledCoursesByStudentID(context.Background(), 103)
	if err != nil {
		t.Fatalf("CoursesByStudentID() error = %v", err)
	}
	if len(completed) != 2 {
