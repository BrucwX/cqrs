...
func (q *Data) PageEnrollments(ctx context.Context, page, pageSize int) ([]*enrollment.CourseEnrollment, error) {
...
func (q *Data) EnrolledCoursesByStudentID(ctx context.Context, studentID int64) ([]*course.Course, error) {
	query := `
...
func (q *Data) EnrolledStudentsByCourseID(ctx context.Context, courseID string) ([]*student.Student, error) {
	query := `
