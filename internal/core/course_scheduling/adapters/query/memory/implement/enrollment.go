...
func NewCourseEnrollmentQuery(d *memory.Data) repoquery.CourseEnrollmentQuery {
	return &courseEnrollmentQuery{data: d}
}

// Page 分页查询课程注册列表。
func (q *courseEnrollmentQuery) Page(_ context.Context, page, pageSize int) ([]*enrollment.CourseEnrollment, error) {
...
func (q *courseEnrollmentQuery) CoursesByStudentID(_ context.Context, studentID int64) ([]*course.Course, error) {
...
func (q *courseEnrollmentQuery) StudentsByCourseID(_ context.Context, courseID string) ([]*student.Student, error) {
