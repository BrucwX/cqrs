...
func seedTeacher(t *testing.T, d *memImp4test.Data, id, studentID int64) {
	t.Helper()
...
func seedCourse(t *testing.T, d *memImp4test.Data, id, courseTypeID string) {
	t.Helper()
...
func seedEnrollment(t *testing.T, d *memImp4test.Data, id int64, courseID string, status enrollment.Status) {
	t.Helper()
...
func seedAbsence(t *testing.T, d *memImp4test.Data, id int64, courseID string) {
	t.Helper()
